...
//************************************************mail*************************************************************************
	$subject    = 'Register your interest';
			$to         = 'karnatirajesh0@gmail.com';
			$headers  = "From: karnatirajesh0@gmail.com \r\n";
                ...
                <ul>
                  <li><a href="#">Models</a>
                    <ul class="sub_menu" style="display: none">
                      <li>
                      <div class="car"><a href="wraith.html"><img src="img/m-wraith-menu.png" alt=""></a></div>
                      <div class="car_con"><a href="wraith.html">Wraith</a><p><a href="#">Effortless simplicity</a></p></div></li>
                      <li><div class="car"><a href="ghost.html"><img src="img/m-ghost-menu.png" alt=""></a></div>
                      <div class="car_con"><a href="ghost.html">Ghost</a><p><a href="#">Effortless simplicity</a></p></div></li>
                      <li><div class="car"><a href="phantom.html"><img src="img/m-phantom-menu.png" alt=""></a></div><div class="car_con"><a href="phantom.html">Phantom</a><p><a href="#">Effortless simplicity</a></p></div></li>
                      <li><div class="car"><a href="dawn.html"><img src="img/m-dawn-menu.png" alt=""></a></div>
                      <div class="car_con"><a href="dawn.html">Dawn</a><p><a href="#">Effortless simplicity</a></p></div></li>
                    </ul>

                  </li>
                  <li><a href="rols-exp.html">The Rolls-Royce Experience</a></li>
...
<div class="group1">
      <input type="checkbox" id="ryi-tnc" name="ryi-tnc" required/>
    <label for="ryi-tnc">I have read and agreed to the <a href="#">terms and conditions</a></label>
    
  </div>

  <div class="group1">
      <input type="checkbox" id="ryi-pp" name="ryi-pp" required/>
